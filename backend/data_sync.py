...
LOOKAHEAD_DAYS_BY_LEAGUE = {"epl": 7, "ucl": 14, "uel": 14, "world_cup": 35, "la_liga": 7, "mls": 7, "liga_mx": 21, "la_liga": 14}
        ...
        if league == "world_cup":
            ...
            try:
                for tid in team_ids:
                    ...
                    # Applies to all leagues at season start (EPL Aug, La Liga Aug,
                    # Liga MX Jul, etc.) — ensures predictions from day 1.
                    if len(recent) < 5:
