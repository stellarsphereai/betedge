...
:80 {
    ...
    @api path /predictions* /ev-bets* /bets /bets/* /stats* /fixtures* /run-model /digest-preview /send-digest /backtest* /sync-data* /quota /scheduler* /anomalies* /model-health* /league-config* /portfolio* /match-analysis*
    handle @api {
